...
<p align="center">
  ...
  <br>
  <video controls width="800" poster="rsi-alert-system-rust-free.png">
    <source src="rsi-alert-system-rust-trimmed.webm" type="video/webm">
    <source src="rsi-alert-system-rust-trimmed.mp4" type="video/mp4">
    Your browser doesn't support embedded video.
    <a href="rsi-alert-system-rust-trimmed.webm">Download WebM</a> ·
    <a href="rsi-alert-system-rust-trimmed.mp4">Download MP4</a>
  </video>
</p>
